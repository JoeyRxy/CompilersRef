	...
	public void Analysis(String[] code, Vector<Integer> action, String[] lex) {
		...
		for (int i = 0; i < action.size(); i++) {
			if (action.get(i) == -1) {
				...
				else if (lex[index].equals("ROP_3") || lex[index].equals("ROP_2") || lex[index].equals("ROP_1")
						|| lex[index].equals("ROP_0") || lex[index].equals("IOP_3") || lex[index].equals("IOP_2")
						|| lex[index].equals("JOP_2") || lex[index].equals("JOP_1") || lex[index].equals("HOP_1"))
	...
	public void regulation(int Serial) {
		switch (Serial) {
			...
			case 11:
				...
				break;
			case 12:
				code_body cb = new code_body((Register) nonter.pop(), (Register) nonter.pop(), (Register) nonter.pop(),
						(Operation) nonter.pop());
				nonter.push(cb);
				break;
			case 13:
				code_body cb2 = new code_body(new Register(), (Register) nonter.pop(), (Register) nonter.pop(),
						(Operation) nonter.pop());
				nonter.push(cb2);
				break;
			case 14:
				code_body cb3 = new code_body(new Register(), new Register(), (Register) nonter.pop(),
						(Operation) nonter.pop());
				nonter.push(cb3);
				break;
			case 15:
				...
				break;
			case 16:
				code_body cb5 = new code_body((int_literal) nonter.pop(), (Register) nonter.pop(),
						(Register) nonter.pop(), (Operation) nonter.pop());
				nonter.push(cb5);
				break;
			case 17:
				code_body cb6 = new code_body((IDENT) nonter.pop(), (Register) nonter.pop(), (Register) nonter.pop(),
						(Operation) nonter.pop());
				nonter.push(cb6);
				break;
			case 18:
				code_body cb7 = new code_body((IDENT) nonter.pop(), new Register(), (Register) nonter.pop(),
						(Operation) nonter.pop());
				nonter.push(cb7);
				break;
			case 19:
				code_body cb8 = new code_body(new Register(), (Register) nonter.pop(), (Register) nonter.pop(),
						(Operation) nonter.pop());
				nonter.push(cb8);
				break;
			case 20:
				code_body cb9 = new code_body(new Register(), new Register(), (Register) nonter.pop(),
						(Operation) nonter.pop());
				nonter.push(cb9);
				break;
			case 21:
				code_body cb10 = new code_body((int_literal) nonter.pop(), new Register(), new Register(),
						(Operation) nonter.pop());
				nonter.push(cb10);
				break;
			case 22:
				code_body cb11 = new code_body((IDENT) nonter.pop(), new Register(), new Register(),
						(Operation) nonter.pop());
				nonter.push(cb11);
				break;
			case 23:
				...
				break;
			case 24:
				code_body cb13 = new code_body((Register) nonter.pop(), (int_literal) nonter.pop(),
						(Register) nonter.pop(), (Operation) nonter.pop());
				nonter.push(cb13);
				break;
			case 25:
				...
				break;
			case 26:
				code_body cb15 = new code_body((Register) nonter.pop(), (int_literal) nonter.pop(),
						(Register) nonter.pop(), (Operation) nonter.pop());
				nonter.push(cb15);
				break;
			case 27:
				code_body cb16 = new code_body(new Register(), new Register(), (Register) nonter.pop(),
						(Operation) nonter.pop());
				nonter.push(cb16);
				break;
			case 28:
