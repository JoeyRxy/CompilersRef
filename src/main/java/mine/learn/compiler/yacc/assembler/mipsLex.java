...
public class mipsLex {
	int[][] TABLE;
	int[] STATE_PATTERN = { -1, -1, 61, 61, 61, 61, 61, 61, 61, 61, 61, 61, 59, 59, 59, 59, 18, 59, 59, 59, 59, 59, 59,
			59, 61, 59, 55, 56, 39, 40, 59, 59, 59, 53, 59, 59, 59, 59, 59, 54, 51, 52, 62, 47, 49, 50, 48, 41, 43, 44,
			46, 45, 42, 59, 59, 59, 57, 58, 37, 38, 60, 59, 36, 59, 59, 59, 59, 34, 35, 59, 59, 59, 32, 31, 33, 59, 59,
			59, 30, 29, 28, 23, 25, 59, 27, 22, 26, 24, 59, 21, 19, 20, 59, 59, 17, 59, 15, 16, 59, 59, 59, 59, 59, 59,
			59, 14, 13, 59, 59, 11, 59, 12, 10, 59, 59, 9, 7, 59, 8, 6, 59, 59, 4, 5, 0, 1, 3, 2, -1, 61, 59 };
	...
	public String LexSynthesis(String temp) {
		if (temp.equals(".DATA") || temp.equals(".CODE") || temp.equals(".SPACE") || temp.equals(".BYTE")
				|| temp.equals(".WORD") || temp.equals(".HALF") || temp.equals("[") || temp.equals("]")
