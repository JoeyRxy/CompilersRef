	...
	public void regulation(int Serial) {
		switch (Serial) {
			...
			case 6:
				...
				break;
			case 7:
				var_decl var2 = new var_decl((int_literal) nonter.pop(), (IDENT) nonter.pop(),
						(type_spec) nonter.pop());
				nonter.push(var2);
				break;
			case 8:
			...
			case 9:
				...
				break;
			case 10:
				fun_decl fun = new fun_decl((compound_stmt) nonter.pop(), (params) nonter.pop(),
						(FUNCTION_IDENT) nonter.pop(), (type_spec) nonter.pop());
				nonter.push(fun);
				break;
			case 11:
				fun_decl fun2 = new fun_decl((params) nonter.pop(), (FUNCTION_IDENT) nonter.pop(),
						(type_spec) nonter.pop());
				nonter.push(fun2);
				break;
			case 12:
			...
			case 25:
				...
				break;
			case 26:
				local_decl loc2 = new local_decl((int_literal) nonter.pop(), (IDENT) nonter.pop(),
						(type_spec) nonter.pop());
				nonter.push(loc2);
				break;
			case 27:
