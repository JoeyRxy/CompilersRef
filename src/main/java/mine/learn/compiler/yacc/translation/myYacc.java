package mine.learn.compiler.yacc.translation;
...
public class myYacc {
	...
	public String terminals[] = { "#", "IDENT", "VOID", "INT", "WHILE", "IF", "ELSE", "RETURN", "EQ", "NE", "LE", "GE",
			"AND", "OR", "DECNUM", "CONTINUE", "BREAK", "HEXNUM", "LSHIFT", "RSHIFT", ";", "[", "]", "(", ")", ",", "{",
			"}", "=", "$", "<", ">", "+", "-", "*", "/", "%", "!", "&", "^", "~", "|" };
	public String nonterminals[] = { "program", "decl_list", "decl", "var_decl", "type_spec", "fun_decl",
			"FUNCTION_IDENT", "params", "param_list", "param", "compound_stmt", "compound", "local_decls", "local_decl",
			"stmt_list", "stmt", "expr_stmt", "while_stmt", "WHILE_IDENT", "block_stmt", "if_stmt", "return_stmt",
			"expr", "int_literal", "arg_list", "args", "continue_stmt", "break_stmt" };
			...
			if (findTerminal(ss[index]) != -1) {
				...
				if (temp.charAt(0) == 's') {
					...
					regulation.addElement(-1);
						...
						&& (findNonterminal(Integer.parseInt(temp.substring(1))) != -1 || temp.equals("r0"))) {
